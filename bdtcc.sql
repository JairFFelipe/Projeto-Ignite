...
--
-- Host: 127.0.0.1
-- Tempo de geração: 11-Set-2025 às 16:29
...
(10, '2025_09_11_142545_campos_nullable', 2);
...
CREATE TABLE `pedidos` (
  ...
  `cod_rastreio` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `produto` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
('THxHNV3LbCLIlaf5idhMzLyQD6PDEIyJUw6yG9Yf', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoicVo3YTFCV3l0dmxQRVVBVFczSVlFWWlYQ2dvcU5YUUlTdVd0cWJqayI7czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MjE6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMCI7fXM6NjoiX2ZsYXNoIjthOjI6e3M6Mzoib2xkIjthOjA6e31zOjM6Im5ldyI7YTowOnt9fX0=', 1757600558);
...
('root', '2025-09-11 14:29:39', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt\"}');
