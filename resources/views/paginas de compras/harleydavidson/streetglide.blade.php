...
<section x-data="{ aba: 'resumo' }" class="mt-[7vh]">
    ...
    <div class="flex justify-between items-center p-6 border-b border-gray-200">
        <h1 class="text-xl font-bold text-orange-600 uppercase">Harley-Davidson Street Glide</h1>
    ...
    <main class="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="relative min-h-[500px] mb-[20vh]">
            <div class="overflow-auto h-full">
                ...
                >
                    <h2 class="text-5xl font-extrabold text-gray-900 mb-4">STREET GLIDE</h2>
                    <p class="uppercase text-sm tracking-widest text-orange-600 font-semibold mb-2">Sport / Classic</p>
                    <p class="text-2xl font-bold text-gray-800 mb-6">
                        A partir de <span class="text-orange-600">R$ 175.500,00</span>
                    </p>
                ...
                >
                    ...
                    <div class="grid sm:grid-cols-2 gap-6 text-sm text-gray-700">
                        ...
                        <div class="p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                <li><strong>Tipo:</strong> V-Twin evoluído, refrigeração a ar/óleo</li>
                                <li><strong>Cilindrada:</strong> ~975 cc (estimado modelo)</li>
                                <li><strong>Potência Máxima:</strong> ~93 cv @ ~7.500 rpm</li>
                                <li><strong>Torque Máximo:</strong> ~95 Nm @ ~5.000 rpm</li>
                        ...
                        <div class="p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                <li><strong>Chassi:</strong> Estrutura Robust-Flex (Softail)</li>
                                <li><strong>Comprimento:</strong> ~2.215 mm</li>
                                <li><strong>Altura do Assento:</strong> ~750 mm</li>
                                <li><strong>Peso em Ordem de Marcha:</strong> ~223 kg</li>
                                <li><strong>Tanque de Combustível:</strong> ~12,5 litros</li>
                                <li><strong>Distância Entre Eixos:</strong> ~1.520 mm</li>
                            </ul>
                        </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                ...
                                <li><strong>Freio Traseiro:</strong> Disco único com ABS</li>
                                <li><strong>Pneus:</strong> 120/70-17 (D) | 160/60-17 (T)</li>
                            </ul>
                        </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                <li><strong>ABS:</strong> Sim, canal duplo</li>
                                <li><strong>Controle de Tração:</strong> Sim</li>
                                <li><strong>Iluminação:</strong> Full LED</li>
                                <li><strong>Painel:</strong> LCD moderno com conectividade</li>
                    ...
                    <p class="text-xs text-gray-500 italic">
                        *Dados técnicos aproximados, baseados em especificações divulgadas pela marca. Modelo homologado para uso em via pública.
                    </p>
                </div>
                ...
                >
                    ...
                    <div class="space-y-4 text-gray-700">
                        <div class="flex justify-between items-center w-[34vw] bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            <div><h3 class="font-semibold text-gray-900">Banco Slim Sport</h3><p class="text-sm text-gray-500">Design mais esportivo e perfil baixo.</p></div>
                            <span class="text-orange-600 font-bold text-lg">R$ 2.800,00</span>
                        </div>

                        <div class="flex justify-between items-center w-[34vw] bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            <div><h3 class="font-semibold text-gray-900">Escapamento Slip-On Performance</h3><p class="text-sm text-gray-500">Melhora resposta e som mais agressivo.</p></div>
                            <span class="text-orange-600 font-bold text-lg">R$ 8.500,00</span>
                        </div>

                        <div class="flex justify-between items-center w-[34vw] bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            <div><h3 class="font-semibold text-gray-900">Capacete Dark Edition</h3><p class="text-sm text-gray-500">Visor escurecido e acabamento especial.</p></div>
                            <span class="text-orange-600 font-bold text-lg">R$ 1.900,00</span>
                        </div>

                        <div class="flex justify-between items-centerv w-[34vw] bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            <div><h3 class="font-semibold text-gray-900">Manoplas Grip Premium</h3><p class="text-sm text-gray-500">Maior conforto e aderência na pilotagem.</p></div>
                            <span class="text-orange-600 font-bold text-lg">R$ 750,00</span>
                        </div>
                    </div>
            ...
            <div 
                x-data="{
                    ...
                    acessorios: [
                        ...
                        { nome: 'Capacete Dark Edition', preco: 1900, selecionado: false },
                        { nome: 'Manoplas Grip Premium', preco: 750, selecionado: false }
                    ],
                    precoBase: 145250,
                    get total() {
