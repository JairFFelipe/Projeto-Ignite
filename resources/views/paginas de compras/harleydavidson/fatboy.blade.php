...
<section x-data="{ aba: 'resumo' }" class="mt-[7vh]">
    ...
    <div class="flex justify-between items-center p-6 border-b border-gray-200">
        <h1 class="text-xl font-bold text-orange-600 uppercase">Harley-Davidson Fat Boy</h1>
    ...
    <main class="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="relative min-h-[500px] mb-[20vh]">
            <div class="overflow-auto h-full">
                ...
                >
                    <h2 class="text-5xl font-extrabold text-gray-900 mb-4">FAT BOY</h2>
                    <p class="uppercase text-sm tracking-widest text-orange-600 font-semibold mb-2">Cruiser / Iconic</p>
                    <p class="text-2xl font-bold text-gray-800 mb-6">
                        A partir de <span class="text-orange-600">R$ 124.900,00</span>
                    </p>
                    ...
                    <p class="text-sm text-gray-600 leading-relaxed">
                        A Harley-Davidson Fat Boy une presença robusta e desempenho refinado. O motor V-Twin entrega torque potente em qualquer regime.
                        Ideal para quem quer uma cruiser icônica com estilo e conforto.
                    </p>
                </div>
                    ...
                    <div class="grid sm:grid-cols-2 gap-6 text-sm text-gray-700">
                        ...
                        <div class="p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                ...
                                <li><strong>Potência Máxima:</strong> ~92 cv @ ~5.500 rpm</li>
                                <li><strong>Torque Máximo:</strong> ~160 Nm @ ~3.250 rpm</li>
                                <li><strong>Transmissão:</strong> 6 marchas com embreagem assistida</li>
                        ...
                        <div class="p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                <li><strong>Chassi:</strong> Estrutura de aço tubular robusta</li>
                                <li><strong>Comprimento × Largura × Altura:</strong> ~2.440 × 960 × 1.165 mm</li>
                                <li><strong>Altura do Assento:</strong> ~690 mm</li>
                                <li><strong>Peso em Ordem de Marcha:</strong> ~339 kg</li>
                                <li><strong>Tanque de Combustível:</strong> ~18,9 litros</li>
                                <li><strong>Distância Entre Eixos:</strong> ~1.575 mm</li>
                            </ul>
                        </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                <li><strong>Dianteira:</strong> Garfo telescópico de Ø 49 mm</li>
                                <li><strong>Traseira:</strong> Duplo amortecedor com pré-carga ajustável</li>
                                <li><strong>Freio Dianteiro:</strong> Disco duplo com ABS</li>
                                <li><strong>Freio Traseiro:</strong> Disco com ABS</li>
                                <li><strong>Pneus:</strong> 160/60-18 (D) | 180/65-16 (T)</li>
                            </ul>
                        </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                ...
                                <li><strong>Iluminação:</strong> LED total</li>
                                <li><strong>Painel:</strong> TFT com conectividade e mapas</li>
                                <li><strong>Velocidade Máxima:</strong> ~185 km/h (estimada)</li>
                            </ul>
                        </div>
                ...
                >
                    ...
                    <div class="space-y-4 text-gray-700">
                        <div class="flex justify-between items-center w-[34vw] bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            <div><h3 class="font-semibold text-gray-900">Banco Slim Custom</h3><p class="text-sm text-gray-500">Assento de perfil baixo para estilo clássico.</p></div>
                            <span class="text-orange-600 font-bold text-lg">R$ 3.800,00</span>
                        </div>

                        <div class="flex justify-between items-center w-[34vw] bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            <div><h3 class="font-semibold text-gray-900">Escapamento Dual Shotgun Screamin’ Eagle</h3><p class="text-sm text-gray-500">Potência extra e sonoridade marcante.</p></div>
                            <span class="text-orange-600 font-bold text-lg">R$ 10.800,00</span>
                        </div>

                        <div class="flex justify-between items-center w-[34vw] bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            <div><h3 class="font-semibold text-gray-900">Guidão Mini Ape 12”</h3><p class="text-sm text-gray-500">Pegada mais alta para conforto em longas viagens.</p></div>
                            <span class="text-orange-600 font-bold text-lg">R$ 2.400,00</span>
                        </div>

                        <div class="flex justify-between items-center w-[34vw] bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            <div><h3 class="font-semibold text-gray-900">Kit Farol LED Daymaker</h3><p class="text-sm text-gray-500">Iluminação potente e visual moderno.</p></div>
                            <span class="text-orange-600 font-bold text-lg">R$ 3.600,00</span>
                        </div>
                    </div>
        ...
        <div class="flex flex-col items-center ml-20">
            <img src="{{ asset('img/harleyfatboy.webp') }}" alt="Harley-Davidson Fat Boy" class="w-full max-w-lg object-contain ml-10">
            ...
            <div
                x-data="{
                    ...
                    acessorios: [
                        { nome: 'Banco Slim Custom', preco: 3800, selecionado: false },
                        { nome: 'Escapamento Dual Shotgun Screamin’ Eagle', preco: 10800, selecionado: false },
                        { nome: 'Guidão Mini Ape 12”', preco: 2400, selecionado: false },
                        { nome: 'Kit Farol LED Daymaker', preco: 3600, selecionado: false }
                    ],
                    precoBase: 124900,
                    get total() {
