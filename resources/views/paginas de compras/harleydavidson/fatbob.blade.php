...
<section x-data="{ aba: 'resumo' }" class="mt-[7vh]">
    ...
    <div class="flex justify-between items-center p-6 border-b border-gray-200">
        <h1 class="text-xl font-bold text-orange-600 uppercase">Harley-Davidson Fat Bob</h1>
    ...
    <main class="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="relative min-h-[500px] mb-[20vh]">
            <div class="overflow-auto h-full">
                ...
                >
                    <h2 class="text-5xl font-extrabold text-gray-900 mb-4">FAT BOB</h2>
                    <p class="uppercase text-sm tracking-widest text-orange-600 font-semibold mb-2">Cruiser / Muscle</p>
                    <p class="text-2xl font-bold text-gray-800 mb-6">
                        A partir de <span class="text-orange-600">R$ 129.900,00</span>
                    </p>
                    ...
                    <p class="text-sm text-gray-600 leading-relaxed">
                        A Harley-Davidson Fat Bob entrega visual agressivo e torque abundante com motor V-Twin de alto desempenho.
                        Uma moto robusta, com presença marcante e estilo “muscle cruiser” para quem busca potência e atitude.
                    </p>
                </div>
                ...
                >
                    ...
                    <div class="grid sm:grid-cols-2 gap-6 text-sm text-gray-700">
                        ...
                        <div class="p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                ...
                                <li><strong>Potência Máxima:</strong> ~92 cv @ ~5.250 rpm</li>
                                <li><strong>Torque Máximo:</strong> ~163 Nm @ ~3.500 rpm</li>
                                <li><strong>Transmissão:</strong> 6 marchas com dupla embreagem (DCT)</li>
                        ...
                        <div class="p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                <li><strong>Chassi:</strong> Tubular em aço com geometria robusta</li>
                                <li><strong>Comprimento × Largura × Altura:</strong> ~2.390 × 955 × 1.140 mm</li>
                                <li><strong>Altura do Assento:</strong> ~770 mm</li>
                                <li><strong>Peso em Ordem de Marcha:</strong> ~320 kg</li>
                                <li><strong>Tanque de Combustível:</strong> ~17 litros</li>
                                <li><strong>Distância Entre Eixos:</strong> ~1.635 mm</li>
                            </ul>
                        </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                ...
                                <li><strong>Pneus:</strong> 130/60-19 (D) | 180/55-18 (T)</li>
                            </ul>
                        </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <<ul class="space-y-1">
                                ...
                                <li><strong>Velocidade Máxima:</strong> ~180 km/h (estimada)</li>
                            </ul>
                        </div>
                    ...
                    <p class="text-xs text-gray-500 italic">
                        *Dados técnicos aproximados, baseados em especificações da fabricante. Modelo homologado para uso em via pública.
                    </p>
                </div>
                ...
                >
                    ...
                    <div class="space-y-4 text-gray-700">
                        <div class="flex justify-between items-center w-[34vw] bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            <div><h3 class="font-semibold text-gray-900">Banco Slim Performance</h3><p class="text-sm text-gray-500">Assento de perfil baixo para postura agressiva.</p></div>
                            <span class="text-orange-600 font-bold text-lg">R$ 4.200,00</span>
                        </div>

                        <div class="flex justify-between items-center w-[34vw] bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            <div><h3 class="font-semibold text-gray-900">Escapamento 2-1 Slip-On Screamin’ Eagle</h3><p class="text-sm text-gray-500">Melhora desempenho e sonoridade agressiva.</p></div>
                            <span class="text-orange-600 font-bold text-lg">R$ 11.500,00</span>
                        </div>

                        <div class="flex justify-between items-center w-[34vw] bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            <div><h3 class="font-semibold text-gray-900">Kit Suspensão Ajustável</h3><p class="text-sm text-gray-500">Amortecedor traseiro regulável para estrada/passeio.</p></div>
                            <span class="text-orange-600 font-bold text-lg">R$ 5.900,00</span>
                        </div>

                        <div class="flex justify-between items-center w-[34vw] bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            <div><h3 class="font-semibold text-gray-900">Guidão Drag Bar Performance</h3><p class="text-sm text-gray-500">Pegada agressiva e visual custom.</p></div>
        ...
        <div class="flex flex-col items-center ml-20">
            <img src="{{ asset('img/fatbob.webp') }}" alt="Harley-Davidson Electra Glide" class="w-full max-w-lg object-contain">
        ...
        <div 
                x-data="{
                    ...
                    acessorios: [
                        { nome: 'Banco Slim Performance', preco: 4200, selecionado: false },
                        { nome: 'Escapamento 2-1 Slip-On Screamin’ Eagle', preco: 11500, selecionado: false },
                        { nome: 'Kit Suspensão Ajustável', preco: 5900, selecionado: false },
                        { nome: 'Guidão Drag Bar Performance', preco: 2800, selecionado: false }
                    ],
                    precoBase: 129900,
                    get total() {
