...
<section x-data="{ aba: 'resumo' }" class="mt-[7vh]">
    ...
    <div class="flex justify-between items-center p-6 border-b border-gray-200">
        <h1 class="text-xl font-bold text-orange-600 uppercase">Harley-Davidson Electra Glide</h1>
    ...
    <main class="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="relative min-h-[500px] mb-[20vh]">
            <div class="overflow-auto h-full">
                ...
                >
                    <h2 class="text-5xl font-extrabold text-gray-900 mb-4">ELECTRA GLIDE</h2>
                    <p class="uppercase text-sm tracking-widest text-orange-600 font-semibold mb-2">Touring / Grand Tour</p>
                    <p class="text-2xl font-bold text-gray-800 mb-6">
                        A partir de <span class="text-orange-600">R$ 145.795,00</span>
                    </p>
                    ...
                    <p class="text-sm text-gray-600 leading-relaxed">
                        A Harley-Davidson Electra Glide entrega conforto máximo para longas jornadas, com motor V-Twin robusto e tecnologia de ponta.
                        Ideal para quem busca estilo icônico, autonomia e presença nas estradas.
                    </p>
                </div>
                ...
                >
                    ...
                    <div class="grid sm:grid-cols-2 gap-6 text-sm text-gray-700">
                        ...
                        <div class="p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                <li><strong>Tipo:</strong> V-Twin, refrigeração a ar/óleo</li>
                                <li><strong>Cilindrada:</strong> ~1 868 cc</li>
                                <li><strong>Potência Máxima:</strong> ~97 cv @ ~5.000 rpm</li>
                                <li><strong>Torque Máximo:</strong> ~160 Nm @ ~3.250 rpm</li>
                                <li><strong>Transmissão:</strong> 6 marchas com Cruise-Drive®</li>
                        ...
                        <div class="p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                <li><strong>Chassi:</strong> Berço duplo em aço com swingarm robusto</li>
                                <li><strong>Comprimento × Largura × Altura:</strong> ~2.440 × 990 × 1.460 mm</li>
                                <li><strong>Altura do Assento:</strong> ~715 mm</li>
                                <li><strong>Peso em Ordem de Marcha:</strong> ~400 kg</li>
                                <li><strong>Tanque de Combustível:</strong> ~22 litros</li>
                                <li><strong>Distância Entre Eixos:</strong> ~1.600 mm</li>
                            </ul>
                        </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                <li><strong>Dianteira:</strong> Garfo teléscópico de Ø 49 mm</li>
                                <li><strong>Traseira:</strong> Amortecedores duplos com ajuste</li>
                                <li><strong>Freio Dianteiro:</strong> Duplo disco com ABS</li>
                                <li><strong>Freio Traseiro:</strong> Disco com ABS</li>
                                <li><strong>Pneus:</strong> 130/70-18 (D) | 180/55-18 (T)</li>
                            </ul>
                        </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                ...
                                <li><strong>Iluminação:</strong> LED completa, farol Daymaker®</li>
                                <li><strong>Painel:</strong> TFT com conectividade, Apple CarPlay®</li>
                    ...
                    <p class="text-xs text-gray-500 italic">
                        *Dados técnicos aproximados, baseados em especificações da Harley-Davidson. Modelo homologado para uso em via pública.
                    </p>
                </div>
                ...
                >
                    ...
                    <div class="space-y-4 text-gray-700">
                        <div class="flex justify-between items-center w-[34vw] bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            <div><h3 class="font-semibold text-gray-900">Banco Tour Comfort Premium</h3><p class="text-sm text-gray-500">Assento superior para longas jornadas com passageiro.</p></div>
                            <span class="text-orange-600 font-bold text-lg">R$ 3.200,00</span>
                        </div>

                        <div class="flex justify-between items-center w-[34vw] bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            <div><h3 class="font-semibold text-gray-900">Kit Escape Screamin’ Eagle</h3><p class="text-sm text-gray-500">Performance e som inconfundível Harley.</p></div>
                            <span class="text-orange-600 font-bold text-lg">R$ 12.900,00</span>
                        </div>

                        <div class="flex justify-between items-center w-[34vw] bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            <div><h3 class="font-semibold text-gray-900">Bolha Touring Wind Deflector</h3><p class="text-sm text-gray-500">Proteção aerodinâmica premium para rodar com conforto.</p></div>
                            <span class="text-orange-600 font-bold text-lg">R$ 4.100,00</span>
                        </div>

                        <div class="flex justify-between items-center w-[34vw] bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            <div><h3 class="font-semibold text-gray-900">Kit Áudio Boom! Box GTS</h3><p class="text-sm text-gray-500">Sistema multimídia com tela grande, navegação e conectividade.</p></div>
                            <span class="text-orange-600 font-bold text-lg">R$ 8.700,00</span>
                        </div>
                    </div>
        ...
        <div class="flex flex-col items-center ml-20">
            <img src="{{ asset('img/harleyelectraglide.jpg') }}" alt="Harley-Davidson Electra Glide" class="w-full max-w-lg object-contain">
            <p class="mt-2 text-xs text-gray-500">*Imagem meramente ilustrativa</p>

            <!-- Modal de Compra (igual estrutura) -->
            <div 
                x-data="{
                    aberto: false,
                    forma_pagamento: 'cartao',
                    acessorios: [
                      { nome: 'Banco Tour Comfort Premium', preco: 3200, selecionado: false },
                      { nome: 'Kit Escape Screamin’ Eagle', preco: 12900, selecionado: false },
                      { nome: 'Bolha Touring Wind Deflector', preco: 4100, selecionado: false },
                      { nome: 'Kit Áudio Boom! Box GTS', preco: 8700, selecionado: false }
                    ],
                    precoBase: 145795,
                    payment_token: '',
                    card_number: '',
            ...
            >
                ...
                <!-- Fundo escurecido e modal seguem a mesma estrutura que no original -->
                <div 
                    x-show="aberto"
                    x-cloak
