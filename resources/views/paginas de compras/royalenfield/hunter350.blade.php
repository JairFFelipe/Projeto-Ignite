...
<section x-data="{ aba: 'resumo' }" class="mt-[7vh]">
    ...
    <div class="flex justify-between items-center p-6 border-b border-gray-200">
        <h1 class="text-xl font-bold text-orange-600 uppercase">Royal Enfield Hunter 350</h1>
    ...
    <main class="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="relative min-h-[500px] mb-[20vh]">
            <div class="overflow-auto h-full">
                ...
                >
                    <h2 class="text-5xl font-extrabold text-gray-900 mb-4">Hunter 350</h2>
                    <p class="uppercase text-sm tracking-widest text-orange-600 font-semibold mb-2">Standard / Naked / Street</p>
                    <p class="text-2xl font-bold text-gray-800 mb-6">
                        A partir de <span class="text-orange-600">R$ 17.990,00</span>
                    </p>
                    ...
                    <div class="grid sm:grid-cols-2 gap-6 text-sm text-gray-700">
                        ...
                        <div class="p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                ...
                                <li><strong>Comprimento × Largura × Altura:</strong> 2.015 × 800 × 1.070 mm</li>
                                <li><strong>Altura do Assento:</strong> 795 mm</li>
                                <li><strong>Peso em Ordem de Marcha:</strong> 181 kg</li>
                                <li><strong>Tanque de Combustível:</strong> 13 litros</li>
                                <li><strong>Distância Entre Eixos:</strong> 1.335 mm</li>
                            </ul>
                        </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                ...
                                <li><strong>Pneus:</strong> 100/90-19 (dianteiro) | 130/70-18 (traseiro)</li>
                            </ul>
                        </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                ...
                                <li><strong>Painel:</strong> Analógico/digital</li>
                                <li><strong>Velocidade Máxima:</strong> ~120 km/h (estimada)</li>
                            </ul>
                        </div>
