...
<section x-data="{ aba: 'resumo' }" class="mt-[7vh]">
    ...
    <div class="flex justify-between items-center p-6 border-b border-gray-200">
        <h1 class="text-xl font-bold text-orange-600 uppercase">Royal Enfield Interceptor 650cc</h1>
    ...
    <main class="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="relative min-h-[500px] mb-[20vh]">
            <div class="overflow-auto h-full">
                ...
                >
                    <h2 class="text-5xl font-extrabold text-gray-900 mb-4">Interceptor 650cc</h2>
                    <p class="uppercase text-sm tracking-widest text-orange-600 font-semibold mb-2">Twin / Clássica</p>
                    ...
                    <p class="text-sm text-gray-600 leading-relaxed">
                        A Royal Enfield Interceptor 650 oferece pilotagem confortável e estilo clássico com desempenho moderno.
                        Equipado com motor bicilíndrico de 648 cc e eletrônica básica, combina prazer de pilotagem com confiabilidade.
                    </p>
                </div>
                ...
                >
                    ...
                    <div class="grid sm:grid-cols-2 gap-6 text-sm text-gray-700">
                        ...
                        <div class="p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                <li><strong>Tipo:</strong> 2 cilindros paralelos, SOHC, 8 válvulas, refrigeração ar-óleo</li>
                                <li><strong>Cilindrada:</strong> 648 cc</li>
                                <li><strong>Potência Máxima:</strong> 47 cv @ 7.250 rpm</li>
                                <li><strong>Torque Máximo:</strong> 5,2 kgf·m @ 5.250 rpm</li>
                        ...
                        <div class="p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                <li><strong>Chassi:</strong> Duplo berço tubular em aço</li>
                                <li><strong>Comprimento × Largura × Altura:</strong> 2.140 × 770 × 1.120 mm</li>
                                <li><strong>Altura do Assento:</strong> 804 mm</li>
                                <li><strong>Peso em Ordem de Marcha:</strong> 202 kg</li>
                                <li><strong>Tanque de Combustível:</strong> 13,7 litros</li>
                                <li><strong>Distância Entre Eixos:</strong> 1.400 mm</li>
                            </ul>
                        </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                <li><strong>Dianteira:</strong> Garfo telescópico 41 mm</li>
                                <li><strong>Traseira:</strong> Amortecedor duplo com ajuste de pré-carga</li>
                                <li><strong>Freios Dianteiros:</strong> Disco de 320 mm com ABS</li>
        ...
        <div class="flex flex-col items-center">
            <img src="{{ asset('img/royalinterceptor650cc.jpg') }}" alt="Royal Enfield Continental GT 650" class="w-full max-w-lg object-contain">
