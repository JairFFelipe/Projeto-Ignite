...
<section x-data="{ aba: 'resumo' }" class="mt-[7vh]">
    ...
    <div class="flex justify-between items-center p-6 border-b border-gray-200">
        <h1 class="text-xl font-bold text-orange-600 uppercase">Royal Enfield Thunderbird 500x</h1>
    ...
    <main class="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="relative min-h-[500px] mb-[20vh]">
            <div class="overflow-auto h-full">
                ...
                >
                    <h2 class="text-5xl font-extrabold text-gray-900 mb-4">Thunderbird 500x</h2>
                    ...
                    <p class="text-2xl font-bold text-gray-800 mb-6">
                        A partir de <span class="text-orange-600">R$ 25.000,00</span>
                    </p>
                ...
                >
                    <h2 class="text-3xl font-extrabold text-gray-900 mb-6 border-b-2 border-orange-500 inline-block pb-1">
                        Ficha Técnica — Thunderbird 500X
                    </h2>
                    ...
                    <div class="grid sm:grid-cols-2 gap-6 text-sm text-gray-700">
                        ...
                        <div class="p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                <li><strong>Tipo:</strong> Monocilíndrico, 4 tempos, SOHC, refrigeração a ar com injeção eletrônica</li>
                                <li><strong>Cilindrada:</strong> 499 cc</li>
                                <li><strong>Potência Máxima:</strong> 27,2 cv @ 5.250 rpm</li>
                                <li><strong>Torque Máximo:</strong> 41,3 Nm @ 4.000 rpm</li>
                                <li><strong>Transmissão:</strong> 5 marchas</li>
                                <li><strong>Embreagem:</strong> Multidisco, banhada em óleo</li>
                            </ul>
                        </div>
                        ...
                        <div class="p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                <li><strong>Chassi:</strong> Tubular em aço</li>
                                <li><strong>Comprimento × Largura × Altura:</strong> 2.190 × 810 × 1.160 mm</li>
                                <li><strong>Altura do Assento:</strong> 805 mm</li>
                                <li><strong>Peso em Ordem de Marcha:</strong> 197 kg</li>
                                <li><strong>Tanque de Combustível:</strong> 20 litros</li>
                                <li><strong>Distância Entre Eixos:</strong> 1.460 mm</li>
                            </ul>
                        </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                <li><strong>Dianteira:</strong> Garfo telescópico de 41 mm, curso de 130 mm</li>
                                <li><strong>Traseira:</strong> Duas molas a gás com pré-carga ajustável em 5 níveis</li>
                                <li><strong>Freio Dianteiro:</strong> Disco de 300 mm com ABS de canal duplo</li>
                                <li><strong>Freio Traseiro:</strong> Disco de 270 mm com ABS de canal duplo</li>
                                <li><strong>Pneus:</strong> 100/90-18 (dianteiro) | 140/70-17 (traseiro)</li>
                            </ul>
                        </div>
        ...
        <div class="flex flex-col items-center">
            <img src="{{ asset('img/royalthunderbird500x.jpg') }}" alt="Royal Enfield Continental GT 650" class="w-full max-w-lg object-contain">
