...
<section x-data="{ aba: 'resumo' }" class="mt-[7vh]">
    ...
    <main class="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12 items-center">
            ...
            <div class="overflow-auto h-full">
                ...
                >
                    ...
                    <div class="grid sm:grid-cols-2 gap-6 text-sm text-gray-700">
                        ...
                        <div class="p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                ...
                                <li><strong>Potência Máxima:</strong> 77 cv @ ~14.500 rpm (≈80 cv com Ram Air)</li>
                                <li><strong>Torque Máximo:</strong> ~4,0 kgf·m @ alto regime</li>
                        ...
                        <div class="p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                <li><strong>Chassi:</strong> Treliça / quadro leve inspirado em supersport</li>
                                <li><strong>Comprimento × Largura × Altura:</strong> ~ 1.990 × 700–720 × 1.100–1.170 mm (variação por modelo)</li>
                                <li><strong>Altura do Assento:</strong> ~ 785–810 mm</li>
                                <li><strong>Peso em Ordem de Marcha:</strong> ~ 168–175 kg</li>
                                <li><strong>Tanque de Combustível:</strong> ~ 14–15 litros</li>
                        ...
                        <div class="bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                <li><strong>Dianteira:</strong> Horquilla invertida Showa/SFF-BP (ajustável)</li>
                                <li><strong>Traseira:</strong> Amortecedor BFRC-lite / back-link, ajustável</li>
                                <li><strong>Freios Dianteiros:</strong> Duplo disco com pinças radiais e ABS</li>
                                <li><strong>Freio Traseiro:</strong> Disco com ABS</li>
                                <li><strong>Pneus:</strong> 110/70-17 (D) | 150/60-17 (T)</li>
                            </ul>
                        </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                <li><strong>Controle de Tração (KTRC):</strong> Sim (modos)</li>
                                <li><strong>ABS:</strong> Sim</li>
                                <li><strong>Quickshifter (KQS):</strong> Bidirecional</li>
                                <li><strong>Painel:</strong> Instrumentação colorida (ex.: 4,3" / TFT conforme versão)</li>
                                <li><strong>Modos de Pilotagem:</strong> Sport / Road / Rain / Rider (varia por modelo)</li>
                                <li><strong>Velocidade Máxima:</strong> ~230–260 km/h (estimada, depende da versão)</li>
                            </ul>
                        </div>
                    ...
                    <p class="mt-6 text-xs text-gray-500 italic">
                        *Dados baseados em informações oficiais Kawasaki e documentação técnica pública.
                    </p>
                </div>
                    ...
                    <div class="space-y-4 text-gray-700">
                        ...
                        <div class="flex justify-between items-center w-[34vw] bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            <div>
                                ...
                                <p class="text-sm text-gray-500">Escape esportivo em titânio — som e ganho de resposta.</p>
                            </div>
                            <span class="text-orange-600 font-bold text-lg">R$ 6.250,00</span>
                        </div>
                        ...
                        <div class="flex justify-between items-center w-[34vw] bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            <div>
                                ...
                                <p class="text-sm text-gray-500">Minimiza danos em quedas leves; design discreto.</p>
                            </div>
                        ...
                        <div class="flex justify-between items-center w-[34vw] bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            <div>
                                ...
                                <p class="text-sm text-gray-500">Leve, ventilado e com viseira antirrisco — ideal para pilotagem esportiva.</p>
                            </div>
        ...
        <div class="flex flex-col items-center">
            <img src="{{ asset('img/kawasakininjazx4rr.png') }}" alt="Kawasaki Ninja ZX-4RR" class="w-full max-w-lg object-contain">
