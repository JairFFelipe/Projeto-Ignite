...
<section x-data="{ aba: 'resumo' }" class="mt-[7vh]">
    ...
    <div class="flex justify-between items-center p-6 border-b border-gray-200">
        <h1 class="text-xl font-bold text-orange-600 uppercase">Kawasaki Z H2</h1>
    ...
    <main class="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="relative min-h-[500px] mb-[20vh]">
            <div class="overflow-auto h-full">
                ...
                >
                    <h2 class="text-5xl font-extrabold text-gray-900 mb-4">Z H2</h2>
                    <p class="uppercase text-sm tracking-widest text-orange-600 font-semibold mb-2">Naked / Supercharged</p>
                    <p class="text-2xl font-bold text-gray-800 mb-6">
                        A partir de <span class="text-orange-600">R$ 129.990,00</span>
                    </p>
                    ...
                    <p class="text-sm text-gray-600 leading-relaxed">
                        A Kawasaki Z H2 é a versão naked do H2, com motor supercharger de 998 cc e foco em torque e resposta imediata.
                        Projetada para uso rodoviário e track days, combina potência elevada com ergonomia mais ereta típica da linha Z.
                    </p>
                </div>
                ...
                >
                    ...
                    <div class="grid sm:grid-cols-2 gap-6 text-sm text-gray-700">
                        ...
                        <div class="p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                ...
                                <li><strong>Potência Máxima:</strong> 200–230 cv (varia por versão; superior com RAM Air e preparações)</li>
                                <li><strong>Torque Máximo:</strong> elevado em média regime (valor específico conforme versão)</li>
                                <li><strong>Transmissão:</strong> 6 marchas, quickshifter (dependendo da versão)</li>
                        ...
                        <div class="p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                ...
                                <li><strong>Comprimento × Largura × Altura:</strong> ~ 2.070 × 770 × 1.095 mm</li>
                                <li><strong>Altura do Assento:</strong> ~ 825 mm</li>
                                <li><strong>Peso em Ordem de Marcha:</strong> ~ 238–246 kg (varia por versão)</li>
                        ...
                        <div class="bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                <li><strong>Dianteira:</strong> Garfo invertido Öhlins / Showa (conforme versão), totalmente ajustável</li>
                                ...
                                <li><strong>Pneus:</strong> 120/70 ZR17 (D) | 190/55 ZR17 (T)</li>
                            </ul>
                        </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                <li><strong>Controle de Tração (KTRC):</strong> Modos selecionáveis</li>
                                <li><strong>ABS:</strong> Sim (com versão KIBS em algumas variantes)</li>
                                <li><strong>Modos de Pilotagem:</strong> Sport / Road / Rain / Rider (varia por versão)</li>
                                <li><strong>Painel:</strong> TFT colorido com conectividade Bluetooth</li>
                                <li><strong>Recursos Adicionais:</strong> Launch control, quickshifter, ride-by-wire (varia por versão)</li>
                            </ul>
                        </div>
                    ...
                    <p class="mt-6 text-xs text-gray-500 italic">
                        *Valores e especificações podem variar conforme versão e mercado. Dados apresentados são técnicos e de referência.
                    </p>
                </div>
                ...
                >
                    ...
                    <div class="space-y-4 text-gray-700">
                        ...
                        <div class="flex justify-between items-center w-[37vw] bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            <div>
                                <h3 class="font-semibold text-gray-900">Protetor de Motor</h3>
                                <p class="text-sm text-gray-500">Proteção inferior do motor contra impactos e raspagens.</p>
                            </div>
                        ...
                        <div class="flex justify-between items-center w-[37vw] bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            <div>
                                ...
                                <p class="text-sm text-gray-500">Escape em titânio com melhoria de resposta e sonoridade (homologação conforme peça).</p>
                            </div>
                        ...
                        <div class="flex justify-between items-center w-[37vw] bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            <div>
                                <h3 class="font-semibold text-gray-900">Bolha Touring Fumê</h3>
                                <p class="text-sm text-gray-500">Melhora proteção aerodinâmica e conforto em viagens.</p>
                            </div>
                            <span class="text-orange-600 font-bold text-lg">R$ 1.350,00</span>
                        </div>

                        <div class="flex justify-between items-center w-[37vw] bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            <div>
                                <h3 class="font-semibold text-gray-900">Capacete Kawasaki Carbon</h3>
        ...
        <div class="flex flex-col items-center">
            <img src="{{ asset('img/kawasakizh2.png') }}" alt="Kawasaki Z H2" class="w-full max-w-lg object-contain">
            ...
            <div 
                x-data="{
                    ...
                    acessorios: [
                        ...
                        { nome: 'Kit de Escape Akrapovič', preco: 12900, selecionado: false },
