...
<section x-data="{ aba: 'resumo' }" class="mt-[7vh]">
    ...
    <div class="flex justify-between items-center p-6 border-b border-gray-200">
        <h1 class="text-xl font-bold text-orange-600 uppercase">Kawasaki Z1000</h1>
    ...
    <main class="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="relative min-h-[500px] mb-[20vh]">
            <div class="overflow-auto h-full">
                ...
                >
                    <h2 class="text-5xl font-extrabold text-gray-900 mb-4">Z1000</h2>
                    ...
                    <p class="text-2xl font-bold text-gray-800 mb-6">
                        A partir de <span class="text-orange-600">R$ 76.990,00</span>
                    </p>
                    ...
                    <div class="grid sm:grid-cols-2 gap-6 text-sm text-gray-700">
                        ...
                        <div class="p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                ...
                                <li><strong>Torque Máximo:</strong> 111 Nm @ 7.300 rpm</li>
                        ...
                        <div class="p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                ...
                                <li><strong>Comprimento × Largura × Altura:</strong> 2.100 × 800 × 1.060 mm</li>
                        ...
                        <div class="bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                ...
                                <li><strong>Freios Dianteiros:</strong> Duplo disco Brembo 310 mm</li>
                        ...
                        <div class="bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                <li><strong>Controle de Tração:</strong> 3 modos</li>
                                <li><strong>ABS:</strong> Sim</li>
                                <li><strong>Modos de Pilotagem:</strong> Sport / Road / Rain / Rider</li>
                                <li><strong>Painel:</strong> TFT colorido com conectividade Bluetooth</li>
                                <li><strong>Recursos Adicionais:</strong> Quickshifter, ride-by-wire</li>
                            </ul>
                        </div>
                    ...
                    <div class="space-y-4 text-gray-700">
                        ...
                        <div class="flex justify-between items-center w-[34vw] bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            <div>
                                ...
                                <p class="text-sm text-gray-500">Escape em titânio com melhoria de resposta e sonoridade.</p>
                            </div>
        ...
        <div class="flex flex-col items-center">
            <img src="{{ asset('img/kawasakiz1000.png') }}" alt="Kawasaki Z1000" class="w-full max-w-lg object-contain">
