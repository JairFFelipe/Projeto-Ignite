...
<section x-data="{ aba: 'resumo' }" class="mt-[7vh]">
    ...
    <div class="flex justify-between items-center p-6 border-b border-gray-200">
        <h1 class="text-xl font-bold text-orange-600 uppercase">Kawasaki Z650</h1>
    ...
    <main class="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="relative min-h-[500px] mb-[20vh]">
            <div class="overflow-auto h-full">
                ...
                >
                    <h2 class="text-5xl font-extrabold text-gray-900 mb-4">Z650</h2>
                    ...
                    <p class="text-2xl font-bold text-gray-800 mb-6">
                        A partir de <span class="text-orange-600">R$ 38.990,00</span>
                    </p>
                    ...
                    <p class="text-sm text-gray-600 leading-relaxed">
                        A Kawasaki Z650 combina agilidade urbana e desempenho sólido com motor bicilíndrico de 649 cc.
                        Ideal para quem quer pilotagem divertida e conforto no dia a dia.
                    </p>
                </div>
                ...
                >
                    ...
                    <div class="grid sm:grid-cols-2 gap-6 text-sm text-gray-700">
                        ...
                        <div class="p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                <li><strong>Tipo:</strong> Bicilíndrico em linha, DOHC, 8 válvulas</li>
                                <li><strong>Cilindrada:</strong> 649 cc</li>
                                <li><strong>Potência Máxima:</strong> 68 cv @ 8.000 rpm</li>
                                <li><strong>Torque Máximo:</strong> 65,7 Nm @ 6.500 rpm</li>
                                <li><strong>Transmissão:</strong> 6 marchas, embreagem assistida</li>
                            </ul>
                        </div>
                        ...
                        <div class="p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                <li><strong>Chassi:</strong> Treliça em aço tubular</li>
                                <li><strong>Comprimento x Largura x Altura:</strong> 2.090 × 745 × 1.065 mm</li>
                                <li><strong>Altura do Assento:</strong> 790 mm</li>
                                <li><strong>Peso em Ordem de Marcha:</strong> 187 kg</li>
                        ...
                        <div class="bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                <li><strong>Dianteira:</strong> Garfo telescópico, ajustável na pré-carga</li>
                                <li><strong>Traseira:</strong> Amortecedor horizontal Back-link, ajustável</li>
                                <li><strong>Freios Dianteiros:</strong> Duplo disco 300 mm com pinças duplas</li>
                                <li><strong>Freio Traseiro:</strong> Disco simples 220 mm</li>
                                <li><strong>Pneus:</strong> 120/70 ZR17 (D) | 160/60 ZR17 (T)</li>
                            </ul>
                        </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            ...
                            <ul class="space-y-1">
                                ...
                                <li><strong>Modos de Pilotagem:</strong> Road / Rain</li>
                                <li><strong>Painel:</strong> Digital LCD</li>
                    ...
                    <p class="text-xs text-gray-500 italic">
                        *Informações baseadas em dados oficiais Kawasaki. Valores podem variar conforme versão e mercado.
                    </p>
                </div>
                ...
                >
                    ...
                    <div class="space-y-4 text-gray-700">
                        ...
                        <div class="flex justify-between items-center w-[34vw] bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            <div>
                                <h3 class="font-semibold text-gray-900">Capa Personalizada Z650</h3>
                                <p class="text-sm text-gray-500">Protege sua moto contra poeira e arranhões com ajuste sob medida.</p>
                            </div>
                            <span class="text-orange-600 font-bold text-lg">R$ 690,00</span>
                        </div>

                        <!-- Acessório 2 -->
                        <div class="flex justify-between items-center w-[34vw] bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            <div>
                                <h3 class="font-semibold text-gray-900">Kit Escape Esportivo</h3>
                                <p class="text-sm text-gray-500">Melhora o desempenho e o som da moto.</p>
                            </div>
                            <span class="text-orange-600 font-bold text-lg">R$ 3.290,00</span>
                        </div>
                        ...
                        <div class="flex justify-between items-center w-[34vw] bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            <div>
                                ...
                                <p class="text-sm text-gray-500">Minimiza danos em eventuais quedas.</p>
                            </div>
                        ...
                        <div class="flex justify-between items-center w-[34vw] bg-gray-50 p-4 rounded-2xl shadow-sm hover:shadow-md transition">
                            <div>
                                <h3 class="font-semibold text-gray-900">Capacete Kawasaki Z650</h3>
                                <p class="text-sm text-gray-500">Modelo em fibra resistente, confortável e seguro.</p>
                            </div>
                            <span class="text-orange-600 font-bold text-lg">R$ 2.490,00</span>
                        </div>
        ...
        <div class="flex flex-col items-center">
            <img src="{{ asset('img/kawasakiz650.jpg') }}" alt="Kawasaki Z650" class="w-full max-w-lg object-contain">
            ...
            <div 
                x-data="{
                    ...
                    acessorios: [
                        { nome: 'Capa Personalizada Z650', preco: 690, selecionado: false },
                        { nome: 'Kit Escape Esportivo', preco: 3290, selecionado: false },
                        { nome: 'Protetores Laterais de Carenagem', preco: 990, selecionado: false },
                        { nome: 'Capacete Kawasaki Z650', preco: 2490, selecionado: false }
                    ],
                    precoBase: 38990,
                    get total() {
